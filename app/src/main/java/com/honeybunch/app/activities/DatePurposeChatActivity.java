...
public class DatePurposeChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#000'>Select Date Purpose</font>"));
        ...
        FlexboxLayoutManager layoutManager = new FlexboxLayoutManager(DatePurposeChatActivity.this);
        layoutManager.setFlexDirection(FlexDirection.ROW);
        layoutManager.setJustifyContent(JustifyContent.FLEX_START);
        layoutManager.setAlignItems(AlignItems.FLEX_START);
        recyler_chip.setLayoutManager(layoutManager);
        adapter = new FlexboxAdapter(DatePurposeChatActivity.this, myList);
