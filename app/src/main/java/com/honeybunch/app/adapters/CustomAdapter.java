...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.viewHolder> {
    ...
    List<ListViewModels.ViewerList> arrayList;
    Context context;
    OnItemClickListener listener;

    public CustomAdapter(List<ListViewModels.ViewerList> arrayList, Context context, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(viewHolder viewHolder, int position) {
        ListViewModels.ViewerList vList=arrayList.get(position);
        viewHolder.name.setText(vList.getRequesterName() + ", " + vList.getRequesterAge());

        Glide.with(viewHolder.itemView.getContext()).load(vList.getImage())
                .into(viewHolder.image);
        if(vList.getStatus().equalsIgnoreCase("Offline")){
        ...
        viewHolder.message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getConversionId(vList.getRequesterId(), vList.getRequesterAge(),
                        vList.getRequesterName(), vList.getImage());
            }
        });
        viewHolder.bind(vList, listener);
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final ListViewModels.ViewerList item, final CustomAdapter.OnItemClickListener listener) {
    ...
    public interface OnItemClickListener {
        void onItemClick(ListViewModels.ViewerList profile);
    }
}