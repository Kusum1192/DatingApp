...
public class CustomMatchAdapter extends RecyclerView.Adapter<CustomMatchAdapter.viewHolder> {

    List<ListMatchModels.MatchList> arrayList;
    Context context;
    OnItemClickListener listener;

    public CustomMatchAdapter(List<ListMatchModels.MatchList> arrayList, Context context, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(viewHolder viewHolder, int position) {
        ListMatchModels.MatchList mList=arrayList.get(position);
        viewHolder.name.setText(mList.getRequesterName() + ", " + mList.getRequesterAge());

//        Glide.with(viewHolder.itemView.getContext()).load(arrayList.get(position).getImage())
//                .into(viewHolder.image);

        Picasso.get().load(mList.getImage())
                .into(viewHolder.image);

        if(mList.getStatus().equalsIgnoreCase("Offline")){
        ...
        viewHolder.message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getConversionId(mList.getRequesterId(), mList.getRequesterAge(),
                        mList.getRequesterName(), mList.getImage());
            }
        });
        viewHolder.bind(mList, listener);
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final ListMatchModels.MatchList item, final CustomMatchAdapter.OnItemClickListener listener) {
    ...
    public interface OnItemClickListener {
        void onItemClick(ListMatchModels.MatchList profile);
    }
