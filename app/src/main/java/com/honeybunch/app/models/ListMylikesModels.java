...
public class ListMylikesModels {
    ...
    @SerializedName("mylikedList")
    @Expose
    private List<MylikedList> mylikedList = null;
    ...
    public List<MylikedList> getMylikedList() {
        return mylikedList;
    }

    public void setMylikedList(List<MylikedList> mylikedList) {
        this.mylikedList = mylikedList;
    }



    public static class MylikedList {
