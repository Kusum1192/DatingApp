...
public class RefusedUserListModels {
    ...
    @SerializedName("refuseList")
    @Expose
    private List<RefuseList> refuseList = null;
    ...
    public List<RefuseList> getRefuseList() {
        return refuseList;
    }

    public void setRefuseList(List<RefuseList> refuseList) {
        this.refuseList = refuseList;
    }

    public static class RefuseList {
