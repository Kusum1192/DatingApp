...
#package
-keep class com.honeybunch.app.activities.UserLoginActivity.* { *; }
#keep class com.honeybunch.app.Activity.* { *; }
-keep class com.honeybunch.app.models.* { *; }
-keep class com.honeybunch.app.interfaces.* { *; }
#-keep class com.cryptocashe.trendynews.utils.*{*;}
